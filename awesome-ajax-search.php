...
/*
 ...
 License: GPL2
    ...
    Copyright 2013  Jameel Bokhari  ( email : TBA )
...
//Options are separated for cleanliness. To change a static setting or a setting default in the pluggin edit or change this file
//Also contains Tabs
...
class Awesome_AJAX_Search {
	...
	public function display_admin_page(){
		...
		if ( ! $hidesave ){
			...
			echo "<button class='button button-primary' type='submit'>Save Options</button>";
		}
		echo "</form>";
		echo "</div><!-- EOF WRAP -->";
	}
	...
	public function add_admin_page_to_menu(){
		...
		$page_title  = 'Awesome Instant Search Options';
...
// add_action( 'wp_loaded', array($Awesome_AJAX_Search, 'test_function') );
//have not tested this yet, but you should be able to add settings here
// $options = array(
// 	'some_option' => array(
// 			'label' => __('Dumb Label', 'text_domain'),
// 			'default' => 'a string',
// 			'not_null' => true,
// 			'type' => 'str',
// 			'in_menu' => true,
...
// 		)
// 	);
// $Awesome_AJAX_Search->register_options($options);
//Just a starting point, should make more sense down the road.
$Awesome_AJAX_Search->init();
/* EOF */